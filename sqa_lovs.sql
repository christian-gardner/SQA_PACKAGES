...
------ latest fail
 ...
 LEFT JOIN ( SELECT LTRIM(LOANNUMBER,'0') AS LOANNUMBER, CLIENT,  REVIEWER AS BACKLOG,   ASSIGNMENTS  
                     FROM SQA_ICC_BACKLOG  WHERE COMPLETED = 0 ) Q ON ( Q.LOANNUMBER = A.LOANNUMBER AND A.CLIENTCODE = Q.CLIENT);
       ...
       COMMIT;
         ...
         COMMIT;
                ...
                insert into SQA_ICC_PRIOR_LOAN_HISTORY ( PID,     
                                                         LOAN_NBR,    
                                                         CLIENT_CODE, 
                                                         OUTCOME,    
                                                         ICC_DECISION,
                                                 ...
                                                 select  B.PID, 
                                                         ...
                                                         'N/A',   
                                                         'N/A', 
                                                         TRUNC(B.DATE_UPLOADED), 
                                                         TRUNC(B.DATE_TO_REVIEW), 
                                                         TRUNC(B.DATE_TO_REVIEW), 
                                                         'FALSE',
                                                         0,
                                                         0
